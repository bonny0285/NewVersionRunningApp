...
//        for i in arrayMio{
//            print("HELLOOO @",i.count)
//            if username == i {
//                print("utente gia esistente")
//
//                let alert = UIAlertController(title: "YOU HAVE ALREADY TAPPED LIKE", message: "You can't press like more than one time", preferredStyle: .alert)
...
//            } else {
//                print("utente nuovo")
//                run.userLike.append(username)
//                Firestore.firestore().collection(RUN_REFERENCE).document(run.documentID)
//                    .setData([NUMBER_OF_LIKE : run.numLike + 1, USER_LIKE : run.userLike], merge: true)
//                print("USER LIKE",run.userLike)
//
//            }
